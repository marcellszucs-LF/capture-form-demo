        ...
        <AriaTooltipTrigger {...{ trigger, delay, closeDelay, isDisabled, isOpen, defaultOpen, onOpenChange }}>
            ...
            >
                {({ isEntering, isExiting }) => (
                    <div
                        className={cx(
                            "z-50 flex max-w-xs origin-(--trigger-anchor-point) flex-col items-start gap-0.5 rounded-lg p-3 shadow-lg will-change-transform",
                            color === "error" ? "bg-error-secondary" : "bg-primary-solid",
                            !description && "py-2",
                    ...
                    >
                        <span className={cx("text-xs font-semibold", color === "error" ? "text-primary" : "text-white")}>{title}</span>

                        {description && <span className={cx("text-xs font-medium", color === "error" ? "text-primary" : "text-tooltip-supporting-text")}>{description}</span>}
                        ...
                        {arrow && (
                            <AriaOverlayArrow>
                                <svg
                                    viewBox="0 0 100 100"
                                    className={cx(
                                        "size-2.5 in-placement-left:-rotate-90 in-placement-right:rotate-90 in-placement-top:rotate-0 in-placement-bottom:rotate-180",
                                        color === "error" ? "fill-bg-error-secondary" : "fill-bg-primary-solid",
                                    )}
                                >
