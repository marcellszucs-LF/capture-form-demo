    ...
    return (
        <AriaButton
            ...
            className={(buttonState) =>
                cx(
                    "relative flex h-11 w-full cursor-pointer items-center rounded-lg bg-primary shadow-xs ring-1 ring-primary outline-hidden transition duration-100 ease-linear ring-inset",
                    (isFocused || isOpen || buttonState.isFocusVisible) && "ring-2 ring-brand",
